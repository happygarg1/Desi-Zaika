            ...
            <body>
              <div class="email-container">
                <div class="email-header">
                  <h1>Welcome to Desi-Zykaa Food!</h1>
                </div>
                <div class="email-body">
                  <p>Hi ${name},</p>
                  <p>Congratulations! Your email has been successfully verified.</p>
                  <p>We are excited to have you on board at Dezi-zykaa Food. Explore our platform and enjoy our services.</p>
                  <p>If you have any questions or need assistance, feel free to reach out to us.</p>
                  <p>Best Regards,<br/>The Desi-zykaa Food Team</p>
                </div>
                <div class="email-footer">
                  <p>&copy; 2024 Desi-zykaa Food. All rights reserved.</p>
                </div>
              </div>
            </body>
          </html>
        ...
        <body>
          <div class="email-container">
            ...
            <div class="email-body">
              ...
              <p>Thank you,<br/>The Dezi-Zykaa Food Team</p>
            </div>
            <div class="email-footer">
              <p>&copy; 2024 Desi-zykaa Food. All rights reserved.</p>
            </div>
        ...
        <body>
          <div class="email-container">
            ...
            <div class="email-body">
              ...
              <p>Thank you,<br/>The Desi-zykaa Food Team</p>
            </div>
            <div class="email-footer">
              <p>&copy; 2024 desi-zykaa Food. All rights reserved.</p>
            </div>
