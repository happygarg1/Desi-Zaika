                ...
                (selectedfilter: string, idx: number) => (
                  ...
                  >
                    ...
                    onClick={()=>setAppliedFilter(selectedfilter)}
                      size={16}
                      className="absolute border rounded-full text-[#D19254] right-1 hover:cursor-pointer"
                    />
                  </div>
                )
              )}
                ...
                (restaurant: Restaurant) => (
                  <Card key={restaurant._id} className="bg-white dark:bg-gray-800 shadow-xl rounded-xl overflow-hidden hover:shadow-2xl transition-shadow duration-300">
                    ...
                    <CardContent className="p-4">
                      <h1 className="text-2xl font-bold text-gray-500 dark:text-gray-100">
                        {restaurant.restaurantName}
                      </h1>
                      <div className="mt-2 gap-1 flex items-center text-gray-600 dark:text-gray-40">
                        <MapPin size={16} />
                        <p className="text-sm">
                          City:{" "}
