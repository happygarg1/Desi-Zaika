...
const Orders = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto py-10 px-6">
            <h1 className="text-3xl font-extrabold text-gray-900 dark:text-white mb-10">Order's Overview</h1>
            <div className="space-y-8">
                {
                    restaurantOrder.map((order)=>(
                        <div className="flex flex-col md:flex-row justify-between items-start sm:items-center bg-white dark:bg-gray-800 shadow-lg rounded-xl p-6 sm:pd-8 border-gray-200 dark:border-gray-700">
